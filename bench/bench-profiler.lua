...
---
--- Lives under bench/ so it stays out of the release zip; the mod reaches it
--- through the loader in scripts/bench-profiler.lua, which falls back to a
--- no-op stub when this directory is absent.
